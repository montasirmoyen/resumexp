    ...
    <section className='flex flex-1 flex-col justify-between gap-12 overflow-x-hidden pt-8 sm:gap-16 sm:pt-16 lg:gap-24 lg:pt-24'>
      ...
      <div className='mx-auto flex max-w-7xl flex-col items-center gap-8 px-4 text-center sm:px-6 lg:px-8'>
        <div className='bg-muted flex items-center gap-2.5 rounded-full border px-3 py-2'>
          ...
          <span className='text-muted-foreground'>Built to help job seekers stand out faster</span>
        </div>
        ...
        <p className='text-muted-foreground'>
          Upload your resume and get instant AI feedback on ATS compliance, content quality,
          <br />
          readability, and job match score with actionable recommendations.
        </p>
